...
**Current Version: 0.3.30** - Beta

## What's New

- Batch Tools with floating window, Set/Add/Multiply/Random operations, Min/Max targeting, Generate Loop, and Generate FPS
- Duplicate Tab with right-click menu
- Backup to Zip for entire mod structure
- Scrollable tab bar for many spawners
- Collapsible spawner list in System view
- Disconnected spawner management with tab dimming and Enable/Disable menu
- Spawner rename syncs to System SpawnerReference
- SpawnerReference overrides preserved on save/export
- FrameSize auto-resolution from texture on import
- UV Motion with correct strength scaling and distortion centering
- EmitOffset now correctly defines random spawn area (zero always included)
- Dark theme forced regardless of Windows system theme
- 30+ easing functions with curve preview
- 55 animation presets across 7 categories with preset browser
- 227 templates across 28 categories
- App scale picker with presets and keyboard shortcuts
